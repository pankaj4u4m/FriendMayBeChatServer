...
public abstract class AbstractDB {
	...
	public AbstractDB(){
		SELECT_USER_ID = "SELECT id FROM "
				+ ApplicationProperties.getProperty("metly.users_db") + " WHERE xmpp=?";
		SELECT_USER_XMPP = "SELECT id FROM "
				+ ApplicationProperties.getProperty("metly.users_db") + " WHERE id=?";
