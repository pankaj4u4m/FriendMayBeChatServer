...
import com.friendmaybe.openfire.dao.FriendmaybeServiceDBClient.Point;
...
public class FriendmaybeAnonymousClient extends AbstractDB implements FriendmaybeServiceClient {
    private static final Logger log = Logger.getLogger(FriendmaybeAnonymousClient.class);
    ...
    public FriendmaybeAnonymousClient() {
        // anonymous
        USER_CORDINATES =
    ...
    private FriendmaybeUser getMatchedUserForStrangerJID(String strangerJID, Timestamp lockDateTime) {
        ...
        try {
            ...
            if (result.next()) {
                ...
                friendmaybeUser.setJID(result.getString(1));
