...
public abstract class AbstractDB {
    ...
    public AbstractDB() {
        SELECT_USER_ID = "SELECT id FROM " + ApplicationProperties.getProperty("friendmaybe.users_db") + " WHERE xmpp=?";
        SELECT_USER_XMPP = "SELECT id FROM " + ApplicationProperties.getProperty("friendmaybe.users_db") + " WHERE id=?";
    ...
    public Long getUserId(JID jid) {
        ...
        try {
            ...
            throw new FriendmaybeException("Error on retrieveing user xmpp:" + jid + ", SQL:\n" + SELECT_USER_ID, e);
        } finally {
    ...
    public String getUserXmpp(Long id) {
        ...
        try {
            ...
            throw new FriendmaybeException("Error on tretrieveing user id:" + id + ", SQL:\n" + SELECT_USER_XMPP, e);
        } finally {
            DbConnectionManager.closeConnection(prepareStatement, connection);
        }
    }
