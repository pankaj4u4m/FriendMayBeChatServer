...
public class FriendmaybeUser {
    ...
    public FriendmaybeUser() {

    }

    public FriendmaybeUser(String jid) {
        this.jid = jid;
    }

    public static FriendmaybeUser getUserFromJSON(String jsonString) {
        try {
            return mapper.readValue(jsonString, FriendmaybeUser.class);
    ...
    public static String getJSONString(FriendmaybeUser user) {
        try {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof FriendmaybeUser)) {
            return false;
        }
        FriendmaybeUser other = (FriendmaybeUser) obj;
        if (DOB == null) {
            if (other.DOB != null) {
                return false;
            }
