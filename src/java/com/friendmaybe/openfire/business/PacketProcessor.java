...
import com.friendmaybe.openfire.plugin.PacketReceiver;
...
public class PacketProcessor implements PacketReceiver {
    ...
    public void receivePacket(Packet packet, Session session, boolean incoming, boolean processed) {
        ...
        log.info("{Packet Received:" + packet + ", incoming:" + incoming + " processed:" + processed + "}");
        ...
        if (packet instanceof Message) {
            ...
            throw new IllegalArgumentException("For:{Packet Received:" + packet + ", incoming:" + incoming
                    + " processed:" + processed + "}");
        }
    }
}
