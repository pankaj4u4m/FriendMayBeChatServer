...
public class ApplicationPropertiesTest {
    ...
    public void testGetPropertyString() {
        Assert.assertNotNull(ApplicationProperties.getProperty("friendmaybe.systemJID"));
        Assert.assertNull(ApplicationProperties.getProperty("nullValue"));
        Assert.assertEquals("friendmaybe@friendmaybe.com", ApplicationProperties.getProperty("friendmaybe.systemJID"));
    }

    @Test
    public void testGetPropertyStringString() {
        Assert.assertNull(ApplicationProperties.getProperty("nullValue1"));
        Assert.assertEquals( "friendmaybe", ApplicationProperties.getProperty("nullValue1", "friendmaybe"));
        Assert.assertEquals( "friendmaybe", ApplicationProperties.getProperty("nullValue1"));
    }
